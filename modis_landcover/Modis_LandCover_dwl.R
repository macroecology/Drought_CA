...
setwd('C:/Assal_working/download_modis')
...
ModisDownload(x=x,h=c(8,9),v=c(4,5),dates=c('2012.01.01'),MRTpath='c:/MRT/MRT_Win/bin', mosaic=T,proj=T,proj_type="UTM",utm_zone=11,datum="WGS84",pixel_size=500)

#ERROR - I get an error... cannot connect to .modisHTTP
